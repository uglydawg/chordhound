...
<head>
    ...
    <title>{{ config('app.name', 'Piano Chords') }}</title>
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        <a href="{{ route('chords.index') }}" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-900 dark:text-gray-100">
                            Chords
                        </a>
                        @auth
                            <a href="{{ route('chords.my-sets') }}" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                                My Sets
                            </a>
                        @endauth
                    </div>
