...
async function testFixedCodeEnabled() {
  console.log('Testing fixed login code 555121 with feature ENABLED...');
  ...
  try {
    ...
    const testEmail = 'test.enabled@example.com';
    ...
    // Now test fixed code
    console.log('\n=== Testing Fixed Code 555121 (ENABLED) ===');
    ...
    if (currentUrl.includes('dashboard')) {
      console.log('✅ SUCCESS! Fixed code 555121 worked and redirected to dashboard!');
    } else {
      console.log('❌ Fixed code did not work - checking errors...');
...
testFixedCodeEnabled().catch(console.error);